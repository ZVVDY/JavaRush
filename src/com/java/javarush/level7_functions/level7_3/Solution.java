package com.java.javarush.level7_functions.level7_3;
 ...
 * Во избежание путаницы внутри метода, измени имена параметров createCrew(), чтобы они
 * соответствовали именам переменных, которые передаются в метод:
 *
 * name1 в navigator
 * name2 в pilot
 * name3 в secondPilot
